        ...
        await event.edit(
            ...
            buttons=[
                ...
                [
                    ...
                    Button.inline("زد إي", data="zedvr"),
                ],
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الالـعــاب 🎮🎳](t.me/UI_XB) .
**- الامـر :**
**⪼** `.بلاي`
...
**- ملاحظـه :**
سـورس زد إي هو اول من كتب فكرة الاشتراك الاجباري واضافها للسورس كـ فكرة جديدة لسورسات تيليثون
