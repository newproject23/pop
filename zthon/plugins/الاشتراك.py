...
async def supc(event):  # Zed-Thon - ZelZal
    ...
    zed_dev = (5650717789, 6348876717, 5650717789, 6348876717)
    ...
    if gvarstatus ("sub_private"):
        try:
            ...
            if "error_code" in reqt:
                await zedub.tgbot.send_message(BOTLOG_CHATID, f"**- خطـأ غير معروف قم باعادة توجيه الرسالة ل@UP_UO لحل المشكلة\n{reqt}**")
