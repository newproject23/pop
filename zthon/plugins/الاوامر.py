...
async def zed_handler(event):
    ...
    query = event.text
    await zedub.get_me()
    if query.startswith("زد إي") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/UI_XB"),],[Button.url("التحـديثـات", "https://t.me/UI_XB"), Button.url("الفـارات", "https://t.me/UI_XT"),],[Button.url("الشـروحـات¹", "https://t.me/UI_XB"),],[Button.url("الشـروحـات²", "https://t.me/UI_XB"),],[Button.url("مطـور السـورس", "https://t.me/UP_UO"),]]
...
async def repozedub(event):
    ...
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await zedub.inline_query(TG_BOT, "زد إي")
    await response[0].click(event.chat_id)
    await event.delete()
...
async def zed_handler(event):
    ...
    if query.startswith("اليدوي") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/UI_XB")]]
